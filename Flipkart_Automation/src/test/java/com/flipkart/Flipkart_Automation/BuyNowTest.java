...
public class BuyNowTest extends TestClass {

    @Test
    public void testBuyNowButton() throws IOException {
        XSSFWorkbook workbook = new XSSFWorkbook("TestRunner.xlsx");
        XSSFSheet sheet = workbook.getSheet("Sheet1");

        String excelExecutionStatus = sheet.getRow(4).getCell(1).getStringCellValue();
