...
public class PriorityTest extends TestClass {
    ...
    public void testAddToCart() throws IOException {
        ...
        String excelExecutionStatus = sheet.getRow(8).getCell(1).getStringCellValue();
    ...
    public void testAddNewItem() throws IOException {
        ...
        String excelExecutionStatus = sheet.getRow(9).getCell(1).getStringCellValue();
        logger.info("Execution Status from Excel: " + excelExecutionStatus);
